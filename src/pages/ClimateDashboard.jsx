...
const temperatureData = [
  ...
  { year: 2023, anomaly: 1.48, description: "Hottest year in recorded history. Ocean temperatures reach unprecedented levels." },
  { year: 2024, anomaly: 1.54, description: "New record set - warmest year ever recorded. Urgent action needed to prevent catastrophic warming." },
  { year: 2025, anomaly: 1.50, description: "Warming trend persists. Global efforts intensify to meet Paris Agreement targets." }
];
            ...
            <Card className="bg-slate-800/50 border-slate-700/50">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-white">
                  ...
                  Atmospheric CO₂ Concentration (1960-2025)
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-[400px]">
